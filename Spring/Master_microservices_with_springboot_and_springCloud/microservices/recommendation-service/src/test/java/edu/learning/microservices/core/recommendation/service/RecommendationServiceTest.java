...
import edu.learning.microservices.core.recommendation.config.MongoConfig;
...
public class RecommendationServiceTest {
    ...
    @Autowired
    private ReactiveMongoTemplate mongoTemplate;  // ✅ Add this to drop collection
    ...
    void create() {
        ...
        assertEquals(2, repository.count().block());  // ✅ Add .block()
    }
